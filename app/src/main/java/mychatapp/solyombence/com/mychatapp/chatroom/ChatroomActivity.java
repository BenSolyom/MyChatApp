...
public class ChatroomActivity extends AppCompatActivity {
    ...
    private void IntializeControllers()
    {
        ...
        SendFilesButton = (ImageButton) findViewById(R.id.send_image_button);
    ...
    protected void onStart()
    {
        ...
        dbRef.child("Messages").child(messageSenderID).child(messageReceiverID)
        ...
        else
        {
            ...
            dbRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task)
                {
                    ...
                    {
                        Toast.makeText(ChatroomActivity.this, "Message Sent Successfully...", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
